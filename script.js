...
const calcDisplaySummary = function(acc){
  ...
  }).filter(function(intrest,i,arr){
    //console.log(arr);
    return intrest >= 1;
  }).reduce(function(acc,intrest){
    return acc + intrest
  },0);
...
console.log(4287802782408429584390853034895n);
console.log(BigInt(4287802782));

//Operations
console.log(10000n + 10000n);
console.log(314324325654645643543n * 1000000n);

const huge = 43232515431543543643n;
const num = 23;
...
console.log(new Date('Sun Nov 20 2022 16:40:20 GMT-0500(Eastern Standard Time)'));

console.log(new Date('September 2, 2020'));
...
console.log('US:       ',new Intl.NumberFormat('us-en', options).format(num));
...
const pizzaTimer = setTimeout(function(ing1, ing2) {
  return console.log(`Here is your pizza! ${ing1} and ${ing2}`);
}, 3000, ...ingredients);          
console.log('Waiting...');
